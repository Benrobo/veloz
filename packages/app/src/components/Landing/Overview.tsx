  ...
  return (
    <FlexColStart className="relative w-full h-auto bg-dark-102 border-t-solid border-t-[1px] border-t-gray-100/30 px-9 py-[6em]">
      <FlexColCenter className="md:max-w-[95%] xl:max-w-[85%] mx-auto">
        <div className="w-full h-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-5">
          <FlexColStart className="w-full h-auto">
            ...
            <p className="text-white-300/40 font-ppSB text-2xl md:text-4xl">
              <span className="text-white-100">Launch with Confidence</span>.
              Our SaaS Starter Kit is equipped with everything you need for a
              seamless project kickstart."
            </p>
          </FlexColStart>
        ...
        <FlexRowStartBtw className="w-full h-auto mt-20 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 ">
