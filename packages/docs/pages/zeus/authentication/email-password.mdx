...
If you want your users to sign-in with Email and Password only, you can do so by updating the `/app/auth/page.(tsx|jsx)` file.
...
```js app/auth/page.jsx focus=18,8
"use client";
import {
  FlexColCenter,
  FlexColStart,
