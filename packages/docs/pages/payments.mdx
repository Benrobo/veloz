...
If everything is set up correctly, it high time you update your pricing plan config on your app. Headover to `src/data/pricing/plan.(ts / js)`. Every plan for your saas is managed within that file.
